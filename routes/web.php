...
Route::get('/historydata', 'PagesController@historydata')->name('historydata');
Route::get('/groupData', 'PagesController@groupData')->name('groupData');
Route::get('/searchData', 'PagesController@searchData')->name('searchData');
